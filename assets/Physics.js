const questions_with_answers = [
  ...
  [
    "Использование электричества является типичным примером когда...",
    "Применять технологии начали первее, чем полностью изучили их природу.",
  ],
  [
  ...
  [
    ...
    `Одновременна, т.к. нет зависимости между массой и ускорением свободного падения.
