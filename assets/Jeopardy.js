const questions_with_answers = [
  ...
  [
    "В функции ax² + bx - c, переменная 'a' определяет...",
    "Переменная 'a' определяет направление ветвей.",
  ],
  [
  ...
  ей угол и угол первой стороны?<img src='/assets/img/Page 5.png'></img>`,
    "При помощи теоремы синусов. AB÷sinα=AC÷sinβ",
  ],
  [`Кто открыл неевклидовую геометрию?`, `Николай Иванович Лобачевский`],
  [
    "Многократное сложение одной стороны прямоугольника, столько раз какая длина задана у другой стороны прямоугольника, разделенная наполовину.",
